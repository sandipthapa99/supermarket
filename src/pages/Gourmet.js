									...
									<figure>
										<div className="snipcart-item block">
											<div className="snipcart-thumb">
												<a href="single.html"><img title=" " alt=" " src="assets/images/gu1.png"/></a>		
												<p>Milk Caramel</p>
							...
							<div className="agile_top_brand_left_grid">
								...
								<div className="agile_top_brand_left_grid1">
									<figure>
										<div className="snipcart-item block">
											<div className="snipcart-thumb">
												<a href="single.html"><img title=" " alt=" " src="assets/images/gu2.png"/></a>		
												<p>Gourmet</p>
							...
							<div className="agile_top_brand_left_grid">
								...
								<div className="agile_top_brand_left_grid1">
									<figure>
										<div className="snipcart-item block">
											<div className="snipcart-thumb">
												<a href="single.html"><img src="assets/images/gu3.png" alt=" " className="img-responsive"/></a>
												<p>Strawberry</p>
							...
							<div className="agile_top_brand_left_grid">
								...
								<div className="agile_top_brand_left_grid1">
									<figure>
										<div className="snipcart-item block">
											<div className="snipcart-thumb">
												<a href="single.html"><img title=" " alt=" " src="assets/images/gu4.png"/></a>		
												<p>Miniatures</p>
												<h4>$35.99 <span>$55.00</span></h4>
											</div>
											<div className="snipcart-details top_brand_home_details">
							...
							<div className="agile_top_brand_left_grid">
								...
								<div className="agile_top_brand_left_grid1">
									<figure>
										<div className="snipcart-item block">
											<div className="snipcart-thumb">
												<a href="single.html"><img title=" " alt=" " src="assets/images/gu5.png"/></a>		
												<p>Le-Gourmet</p>
												<h4>$30.99 <span>$45.00</span></h4>
											</div>
											<div className="snipcart-details top_brand_home_details">
							...
							<div className="agile_top_brand_left_grid">
								...
								<div className="agile_top_brand_left_grid1">
									<figure>
										<div className="snipcart-item block">
											<div className="snipcart-thumb">
												<a href="single.html"><img src="assets/images/gu6.png" alt=" " className="img-responsive"/></a>
												<p>Chocolate Bar</p>
												<h4>$80.99 <span>$105.00</span></h4>
											</div>
											<div className="snipcart-details top_brand_home_details">
							...
							<div className="agile_top_brand_left_grid">
								...
								<div className="agile_top_brand_left_grid1">
									<figure>
										<div className="snipcart-item block">
											<div className="snipcart-thumb">
												<a href="single.html"><img title=" " alt=" " src="assets/images/gu7.png"/></a>		
												<p>Poultry Rub</p>
												<h4>$35.99 <span>$55.00</span></h4>
											</div>
											<div className="snipcart-details top_brand_home_details">
							...
							<div className="agile_top_brand_left_grid">
								...
								<div className="agile_top_brand_left_grid1">
									<figure>
										<div className="snipcart-item block">
											<div className="snipcart-thumb">
												<a href="single.html"><img title=" " alt=" " src="assets/images/gu8.png"/></a>		
												<p>Sandwich</p>
												<h4>$30.99 <span>$45.00</span></h4>
											</div>
											<div className="snipcart-details top_brand_home_details">
							...
							<div className="agile_top_brand_left_grid">
								...
								<div className="agile_top_brand_left_grid1">
									<figure>
										<div className="snipcart-item block">
											<div className="snipcart-thumb">
												<a href="single.html"><img src="assets/images/gu9.png" alt=" " className="img-responsive"/></a>
												<p>Fruit Nut</p>
												<h4>$80.99 <span>$105.00</span></h4>
											</div>
											<div className="snipcart-details top_brand_home_details">
